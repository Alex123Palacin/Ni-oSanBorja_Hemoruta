...
function TarjetaPanel({ children, titulo }: TarjetaPanelProps) {
  return (
    <section className='rounded-xl border border-[#dce5ee] bg-white p-3 shadow-[0_2px_8px_rgba(18,52,91,0.04)]'>
      <h2 className='text-[10px] font-extrabold text-[#102e78]'>{titulo}</h2>
      {children}
    </section>
  )
}
...
function SemaforoActual({ descripcion, valor }: { descripcion: string; valor: string }) {
  return (
    <div className='text-[7px] leading-[11px] text-[#52688d]'>
      <span className='font-semibold'>Semáforo actual</span>
      <strong className='mt-1 flex items-center gap-2 text-[11px] text-[#15953b]'>
...
function TarjetaIndicaciones() {
  return (
    <TarjetaPanel titulo='Indicaciones médicas vigentes'>
      <div className='mt-3 flex gap-2.5'>
        ...
        <p className='text-[8px] font-semibold leading-[13px] text-[#53688d]'>
      ...
      <div className='mt-2 flex gap-2.5 rounded-lg bg-[#f3f8fb] p-2'>
        ...
        <p className='text-[7px] font-semibold leading-[11px] text-[#53688d]'>
...
function TarjetaAdherenciaSintomas({ resumen }: { resumen: ResumenPanelSeguimiento }) {
  return (
    <TarjetaPanel titulo='Adherencia y síntomas'>
      ...
      <div className='mt-2 flex items-center gap-2 rounded-lg bg-[#f3f8fb] p-2'>
        ...
        <p className='text-[7px] leading-[11px] text-[#53688d]'>
          Último síntoma reportado
          <strong className='block text-[8px] text-[#173777]'>{resumen.sintomaReciente.descripcion}</strong>
        </p>
      </div>
    </TarjetaPanel>
  )
...
function TarjetaMedicacion({ onVerHistorial, resumen }: { onVerHistorial: () => void; resumen: ResumenPanelSeguimiento }) {
  return (
    <TarjetaPanel titulo='Medicación'>
      <div className='mt-3 grid grid-cols-[94px_minmax(0,1fr)] items-center gap-3'>
        ...
        <div className='text-[7px] leading-[12px] text-[#52688d]'>
          <span className='font-semibold'>Última dosis omitida</span>
          <strong className='mt-1 flex items-center gap-1.5 text-[9px] text-[#173777]'>
      ...
      <button
        className='mt-3 flex h-8 w-full cursor-pointer items-center justify-center gap-2 rounded-lg border border-[#08aabb] text-[8px] font-bold text-[#26709e] transition hover:bg-[#effafb] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#08aabb]'
  ...
  return (
    <TarjetaPanel titulo='Síntomas'>
      <div className='mt-3 flex items-center gap-3'>
        ...
        <p className='text-[7px] leading-[12px] text-[#52688d]'>
          Último síntoma reportado
          <strong className='block text-[9px] text-[#173777]'>{sintoma.descripcion}</strong>
      ...
      <div className='mt-3'>
        <p className='text-[7px] font-bold text-[#53688d]'>Resumen de síntomas (últimos 7 días)</p>
        <dl className='mt-2 grid grid-cols-3 divide-x divide-[#e1e9f0] text-center'>
          <div className='px-1'>
            <dt className='text-[7px] text-[#607395]'>Total reportes</dt>
            <dd className='mt-1 text-[12px] font-extrabold text-[#173777]'>{sintoma.totalReportes}</dd>
          </div>
          <div className='px-1'>
            <dt className='text-[7px] font-bold text-[#ef3f4b]'>Con alerta</dt>
            <dd className='mt-1 text-[12px] font-extrabold text-[#ef3f4b]'>{sintoma.conAlerta}</dd>
          </div>
          <div className='px-1'>
            <dt className='text-[7px] text-[#607395]'>Sin síntomas</dt>
  ...
  return (
    <TarjetaPanel titulo='Medicación'>
      <div className='mt-3 flex items-center gap-3'>
        ...
        <p className='min-w-0 flex-1 text-[7px] leading-[11px] text-[#52688d]'>
          Última medicación registrada
          <strong className='block text-[8px] text-[#173777]'>{resumen.medicamentoReciente.nombre}</strong>
...
function TarjetaTratamiento({ indicaciones }: { indicaciones: string[] }) {
  return (
    <TarjetaPanel titulo='Tratamiento recomendado'>
      <div className='mt-3 flex gap-2.5'>
        <span className='grid h-9 w-9 shrink-0 place-items-center rounded-full bg-[#dff5f7] text-[#139cb3]'>
          <IconoMedico className='h-5 w-5' nombre='clipboard' />
        </span>
      ...
      <ul className='mt-2 list-disc rounded-lg bg-[#f3f8fb] py-2 pl-6 pr-2 text-[7px] font-semibold leading-[12px] text-[#405881]'>
...
function TarjetaUltimoDocumento({ documento }: { documento: DocumentoSeguimientoPaciente }) {
  return (
    <TarjetaPanel titulo='Documentos'>
      <div className='mt-3 flex items-center gap-3'>
        ...
        <div className='min-w-0 text-[7px] leading-[12px] text-[#52688d]'>
          <span>Último documento recibido:</span>
          <strong className='block truncate text-[10px] text-[#173777]'>{documento.nombre}</strong>
...
function TarjetaResumenDocumental({ resumen }: { resumen: ResumenPanelSeguimiento['resumenDocumental'] }) {
  ...
  return (
    <TarjetaPanel titulo='Resumen documental'>
      <dl className='mt-3 grid grid-cols-4 divide-x divide-[#e1e9f0] text-center'>
        {items.map((item) => (
          <div className='px-1' key={item.texto}>
            ...
            <dt className='text-[6px] font-semibold leading-[9px] text-[#607395]'>{item.texto}</dt>
          </div>
        ))}
      </dl>
    </TarjetaPanel>
...
function PanelLateralSeguimientoComp({
  ...
  return (
    <aside className='space-y-3'>
      ...
      {esDocumento && (
        <>
          <TarjetaUltimoDocumento documento={resumen.documentos[0]} />
