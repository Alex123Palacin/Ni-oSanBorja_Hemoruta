const trazos = {
  ...
  download: 'M12 4v12m-4-4 4 4 4-4M5 19v2h14v-2',
  ...
  phone: 'M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.08 4.18 2 2 0 0 1 4.07 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.68 2.8a2 2 0 0 1-.45 2.11L8.03 9.9a16 16 0 0 0 6.07 6.07l1.27-1.27a2 2 0 0 1 2.11-.45c.9.32 1.84.55 2.8.68A2 2 0 0 1 22 16.92Z',
  ...
  scan: 'M8 4H4v4m12-4h4v4M4 16v4h4m12-4v4h-4M7 12h10',
  ...
  upload: 'M12 16V4m-4 4 4-4 4 4M5 14v6h14v-6',
  ...
  whatsapp: 'M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.198.297-.767.966-.94 1.164-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479s1.065 2.875 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306 1.262.489 1.694.626.712.226 1.36.194 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.29.173-1.414-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.981.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.002-5.448 4.434-9.88 9.885-9.88a9.82 9.82 0 0 1 6.988 2.895 9.825 9.825 0 0 1 2.893 6.99c-.003 5.448-4.435 9.884-9.881 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.3-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.336 11.893-11.893a11.821 11.821 0 0 0-3.474-8.413Z',
...
function IconoMedico({ className = 'h-5 w-5', nombre, strokeWidth = 1.8 }: IconoMedicoProps) {
  const esIconoRelleno = nombre === 'whatsapp'

  return (
    <svg
      aria-hidden='true'
      className={className}
      fill={esIconoRelleno ? 'currentColor' : 'none'}
      stroke={esIconoRelleno ? 'none' : 'currentColor'}
      strokeLinecap='round'
